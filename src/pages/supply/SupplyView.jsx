...
export const SupplyView = () => {
    return (
        <div className='bg-black pt-[90] pb-[90px] px-5 z-50'>
            <div className='max-w-[90rem] relative supply-shadow z-20 mx-auto'>
                <div className=''>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-3 mx-auto justify-center pt-16'>
                        <div className='flex flex-col hover:scale-105 transition-all mx-auto gap-10'>
                            <div className='text-left flex gap-3'>
                                ...
                                <div className='flex flex-col gap-3'>
                                    ...
                                    <div className='text-white lg:text-gray-500'>
                                        1350 million
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='mx-auto hover:scale-105 pt-10 lg:pt-0 transition-all'>
                            <img src={supply} alt='' />
                        </div>
                        <div className='flex flex-col hover:scale-105 transition-all pt-10 lg:pt-0 mx-auto gap-10'>
                            <div className='text-left flex gap-3'>
                            ...
                            <div className='text-left flex gap-3 z-50'>
